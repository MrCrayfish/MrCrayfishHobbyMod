package com.mrcrayfish.rccar.client.model.block.baked;
...
import com.mrcrayfish.rccar.util.QuadHelper;
import com.mrcrayfish.rccar.util.QuadHelper.Vertex;
import com.mrcrayfish.rccar.util.TransformationBuilder;
...
public class BakedRampSlope implements IPerspectiveAwareModel 
{
	...
	public List<BakedQuad> getQuads(IBlockState state, EnumFacing side, long rand) 
	{
		...
		if(state != null)
		{
			...
			boolean stacked = extendedState.getValue(BlockRamp.STACKED);
			boolean metal = extendedState.getValue(BlockRamp.METAL);
